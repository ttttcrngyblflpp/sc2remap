...
fn main() {
    ...
    let mouse_path = futures::executor::block_on(evdev_utils::identify_mouse())
        .expect("failed to identify mouse");
    ...
    futures::executor::block_on(mouse_device.try_for_each(|mouse_event| {
        ...
        match event_code {
            ...
            EventCode::EV_KEY(EV_KEY::BTN_SIDE) => {
                l.inject_key_syn(EV_KEY::KEY_PAGEDOWN, value)
